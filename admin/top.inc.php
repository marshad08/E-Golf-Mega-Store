...
<html class="no-js" lang="">
   ...
   <body>
      <aside id="left-panel" class="left-panel bg-warning">
         <nav class="navbar navbar-expand-sm navbar-default bg-warning">
         ...
         <header id="header" class="header bg-primary">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/logoless.png" alt="Logo"></a>
