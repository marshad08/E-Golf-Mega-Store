...
<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/scott.jpg) no-repeat scroll center center / cover ;">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item text-warning" href="index.php">Home</a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item text-warning active">Login/Register</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="login-form" method="post" class="bg-dark">
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="email" name="email" id="email" placeholder="Your Email*" style="width:67%" required
											>
