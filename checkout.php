...
if(isset($_POST['submit'])){
	...
	//It gives us current id which stored in database 
	...
	//Using for Empty the cart because data inserted in a table
	unset($_SESSION['cart']);
...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/Advance.jpg) no-repeat scroll center center / cover ;">
