...
$meta_title="Welcome To EGolf Mega Store";
$meta_desc="Welcome To EGolf Mega Store";
$meta_keyword="Welcome To EGolf Mega Store";
...
<body>
    ...
    <div class="wrapper">
        <header id="htc__header" class="htc__header__area header--one">
            <div id="sticky-header-with-topbar" class="mainmenu__wrap sticky__header bg-primary">
                <div class="container">
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/egolf_logo.png" alt="logo images"></a>
                                </div>
                            </div>
